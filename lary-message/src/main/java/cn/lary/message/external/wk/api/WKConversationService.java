...
import cn.lary.message.external.wk.dto.conversation.ConversationDeleteDTO;
import cn.lary.message.external.wk.dto.conversation.ConversationUnreadClearDTO;
import cn.lary.message.external.wk.dto.conversation.SyncUserConversationDTO;
import cn.lary.message.external.wk.dto.message.SyncRecentMessagesReq;
import cn.lary.message.external.wk.vo.conversation.ConversationVO;
import cn.lary.message.external.wk.vo.conversation.SyncUserConversationVO;
import cn.lary.message.external.wk.vo.message.RecentMessage;
