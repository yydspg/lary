package cn.lary.module.auth.kit;


import cn.lary.common.kit.StringKit;
import cn.lary.module.auth.core.AuthException;
...
public class GlobalAuthKit {
    ...
    public static String generateDingTalkSignature(String secretKey, String timestamp) {
        ...
        return urlEncode(new String(Base64Kit.encode(signData, false)));
    }
    ...
    public static String urlEncode(String value) {
        ...
        try {
            String encoded = URLEncoder.encode(value, GlobalAuthKit.DEFAULT_ENCODING.displayName());
    ...
    public static String urlDecode(String value) {
        ...
        try {
            return URLDecoder.decode(value, GlobalAuthKit.DEFAULT_ENCODING.displayName());
        } catch (UnsupportedEncodingException e) {
        ...
        if (accessTokenStr.contains("&")) {
            ...
            for (String field : fields) {
                if (field.contains("=")) {
                    ...
                    res.put(GlobalAuthKit.urlDecode(keyValue[0]), keyValue.length == 2 ? GlobalAuthKit.urlDecode(keyValue[1]) : null);
                }
            }
        } else {
            res = new HashMap<>(0);
    ...
    public static String generateTwitterSignature(Map<String, String> params, String method, String baseUrl, String apiSecret, String tokenSecret) {
        ...
        return new String(Base64Kit.encode(signature, false));
    }
    ...
    public static String generateXmlySignature(Map<String, String> params, String clientSecret) {
        TreeMap<String, String> map = new TreeMap<>(params);
        String baseStr = Base64Kit.encode(parseMapToString(map, false));
