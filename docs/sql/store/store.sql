...
CREATE TABLE `store_flow`  (
                                  ...
                                  `category_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '分类ID',
                                  ...
                                  `goods_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '商品名称',
                                  ...
                                  `sku_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NULL DEFAULT NULL COMMENT '货品ID',
                                  ...
                                  `bill_time` datetime(6) NULL DEFAULT NULL COMMENT '结算时间',
                                  `full_refund` bit(1) NULL DEFAULT NULL COMMENT '是否全部退款',
...
CREATE TABLE `store_goods_label`  (
                                         ...
                                         `label_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '店铺商品分类名称',
